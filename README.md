...
0. Download folder Worldometer
1. Open Command line(terminal)
2. Move the command pointer to the location of the downloaded folder
3. Enter the command: [python -m pip install scrapy] to install Scrapy (*condition: the machine already has <pip> and <python 3>)
4. Then enter the command: [scrapy crawl countries ]
### Result:
