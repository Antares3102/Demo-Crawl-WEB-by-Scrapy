...
Open Command line(terminal) -> Eove the command pointer to the location of the downloaded folder -> Enter the command: [python -m pip install scrapy] to install Scrapy (*condition: the machine already has <pip> and <python 3>) -> Then enter the command: [scrapy crawl countries ]
### Result:
